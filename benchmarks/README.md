...
on six public Remotion compositions at 50, 100, 200 and 400 frames.
...
```sh
npm install
node benchmarks/run.mjs                        # all six at 50, 100, 200 and 400 frames
...
Remotion's AWS estimate and measured BlitzFrames usage. The CLI's JSON for each run and
